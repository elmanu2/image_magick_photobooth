...
out_file=${out_dir}gm-${1}-photobooth-4x4.png
...
echo processing...
gm convert ${in_file} -bordercolor black -border ${2}x${3} ${in_tmp_pb1}
gm convert ${in_tmp_pb1} ${in_tmp_pb1} -append ${in_tmp_pb2}
gm convert ${in_tmp_pb2} ${in_tmp_pb2} +append ${out_file}
gm convert ${out_file} -bordercolor black -border $2x$3 ${out_file}
rm ${in_tmp_pb1}
rm ${in_tmp_pb2}
