...
out_file=${out_dir}gm-${1}-frame.png
...
gm convert ${in_frame_file} -scale ${width}x${height}\! ${in_tmp_frame_file}

gm convert ${in_file} ${in_tmp_frame_file} +swap -gravity center -compose DstOver -composite ${out_file}
